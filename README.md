...
- **桌面快捷方式** - 首次运行自动在桌面创建快捷方式（Windows .lnk / macOS symlink）
- **飞书视觉规范** - 配色遵循飞书设计规范（品牌蓝 #3370FF + N 系列灰阶）
...
1. 下载 `dist/飞书日程.exe`
2. 双击运行
3. 首次运行自动弹出登录窗口，或点击月历栏「⚙ 一键登录」完成飞书授权（已授权后该按钮自动隐藏）
...
- **🔍** - 搜索日程（跨月搜索历史和未来日程）
- **⟳** - 刷新日程
- **⚙ 一键登录**（月历栏右侧） - 授权/配置飞书登录（二维码或链接；已授权后自动隐藏）
- **—** - 最小化窗口（点击托盘图标恢复）
- **📤** - 导出当月日程到 Excel
- **📌/📍** - 切换置顶（图标区分状态）
- **⚙** - 打开设置
